<!-- @php 
$basic =\App\Models\BasicSetting::first();
$blog =\App\Models\Blog::orderByDesc('created_at')->limit(2)->get();
@endphp
  ...
  <div class="footer__bottom">
      <div class="container text-left">
        <p class="">&copy; Copyright 2020 All rights reserved developed by 
        CDG Myanmar Ltd....</p>
      </div>
  </div> -->